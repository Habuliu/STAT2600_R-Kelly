...
As seen in Peter's individual plot, we can conclude that the average air speed does not have a predictable effect on arrival delays. It is also intereseting to note that weather delays and security delays are the least likely to be a factor for a delayed flight arriving to Denver. 
