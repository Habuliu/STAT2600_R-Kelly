...
plot(bigRes)
```
For my individual section, I thought I would examine the relationship between individual game measures and winning teams.  
...
My results show a higher than average predictive ability for Power Play shots and Goals. This makes sense, as these stats describe decisive scoring moments,
but it shows their relative importance over other factors. No factor scored higher than .79, which shows that no factor is a perfect predictor of team success. 

After this course, my six month goal remains the same, but with much more exprience to draw from. I wanted to learn more skills to help apply my ideas  
and I feel much more equipped now than at the beginning of the semester. I hope to keep attempting challenging problems, and improving my analytical abilites. 
My five year goal remains the same, but now with more context as to what being a data scientist is. If I could give myself advice at the beginning of the semester, 
 I would encourage myself to attempt the hardest analysis I could each lab, as it would have helped my skillset even more. 
