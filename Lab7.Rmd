...
ggplot(data = Graph) + geom_line(mapping = aes(x = Graph$Month, y = Graph$Total, fill = "red")) + labs(x = "Month", y = "Meter3 total", title = "Water-heater & Air-conditioner usage in 2008") + scale_x_continuous(breaks=c(1,3,5,7,9,11))
```
